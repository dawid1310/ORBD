...
if (isset($_POST['kolo'])) {
    ...
    $kolo->setId($id);
    $kolo->modify($app, 'koloOBJ');
    header("Location: selectOBJ");
}
...
if (isset($_POST['prostokat'])) {
    ...
    $prostokat->setId($id);
    $prostokat->modify($app, 'prostokatOBJ');
    header("Location: selectOBJ");
}
...
if (isset($_POST['pieciokat'])) {
    ...
    $pieciokat->setId($id);
    $pieciokat->modify($app, 'pieciokatOBJ');
    header("Location: selectOBJ");
}
if (isset($_POST['szesciokat'])) {
    ...
    $szesciokat->setId($id);
    $szesciokat->modify($app, 'szesciokatOBJ');
    header("Location: selectOBJ");
}