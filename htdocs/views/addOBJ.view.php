...
<h5> Dodaj kwadrat</h5>
    ...
    <button type="submit" class="btn btn-success float-right" name="kwadratadd">Dodaj</button>
  </div><br><br>
</form></div>
...
<h5>Dodaj prostokąt</h5>
    ...
    <button type="submit" class="btn btn-success float-right" name="prostokatadd">Dodaj</button>
  </div><br><br>
</form></div>
...
<div class="form-group">
    ...
    <button type="submit" class="btn btn-success float-right" name="koloadd">Dodaj</button>
  </div><br><br>
</form></div>
...
<div class="form-group">
    ...
    <button type="submit" class="btn btn-success float-right" name="trojkatadd">Dodaj</button>
  </div><br><br>
</form></div>
