...
<button type="submit" class="btn btn-secondary float-right" name="sub_kolo">Usun</button>
</form> 
...
<button type="submit" class="btn btn-secondary float-right" name="sub_prostokat">Usun</button>
</form> 
...
<button type="submit" class="btn btn-secondary float-right" name="sub_pieciokat">Usun</button>
</form> 
...
<button type="submit" class="btn btn-secondary float-right" name="sub_szesciokat">Usun</button>
</form> 
...
<button type="submit" class="btn btn-secondary float-right" name="sub_trojkat">Usun</button>
</form> 