...
<button type="submit" class="btn btn-secondary float-right" name="mod_typ">Modyfikuj</button>
...
<button type="submit" class="btn btn-secondary float-right" name="mod_kolo">Modyfikuj</button>
</form> 
...
<button type="submit" class="btn btn-secondary float-right" name="mod_kwadrat">Modyfikuj</button>
</form> 
...
<button type="submit" class="btn btn-secondary float-right" name="mod_prostokat">Modyfikuj</button>
</form> 
...
<button type="submit" class="btn btn-secondary float-right" name="mod_pieciokat">Modyfikuj</button>
</form> 
...
<button type="submit" class="btn btn-secondary float-right" name="mod_szesciokat">Modyfikuj</button>
</form> 
...
<button type="submit" class="btn btn-secondary float-right" name="mod_trojkat">Modyfikuj</button>
</form> 