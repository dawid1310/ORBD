...
<a class="btn btn-secondary w-100" href="sfm" role="button">Wstecz</a><br><br>
...
<form action="applyModyfication" method="POST">
...
<button type="submit" class="btn btn-primary float-right" name="sub_kolo">Modyfikuj</button>
</form> 
<?php
}
...
<button type="submit" class="btn btn-primary float-right" name="sub_kwadrat">Modyfikuj</button>
</form> 
<?php
}
...
<button type="submit" class="btn btn-primary float-right" name="sub_prostokat">Modyfikuj</button>
</form> 
<?php
}
...
<button type="submit" class="btn btn-primary float-right" name="sub_pieciokat">Modyfikuj</button>
</form> 
<?php
}
...
<button type="submit" class="btn btn-primary float-right" name="sub_szesciokat">Modyfikuj</button>
</form> 
<?php
}
...
<button type="submit" class="btn btn-primary float-right" name="sub_trojkat">Modyfikuj</button>
</form> 
<?php
}
?>
