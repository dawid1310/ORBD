...
<table class="table w-50 mx-auto">
    <thead class="thead-dark">
        ...
        <tr class="thead-light"><th colspan="2">MODYFIKUJ DANE Z TABELI</th></tr>
        <th scope="col">#</th>
        <th scope="col">Nazwa</th>
    </thead>
    <form action="modifyOBJ" method="POST">
...
<tr>
    ...
    <td>Sześciokąt</td>
        ...
        <tr><td colspan="2">
        <button type="submit" class="btn btn-success float-right">Modyfikuj</button></td></tr></tbody> </table> 
    </form>
